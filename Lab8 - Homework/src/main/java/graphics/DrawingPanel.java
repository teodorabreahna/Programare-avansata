...
public class DrawingPanel extends JPanel {
    ...
    void createOffScreenImage ()
    {
        ...
        try {
            offscreen.drawImage(ImageIO.read(new File("C://Users//teodo//OneDrive//Desktop//Lab8 - Homework//src//main//resources//Mercator.jpg")),0,0,canvasWidth,canvasHeight,frame);
